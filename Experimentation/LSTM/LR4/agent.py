...
class Network():
    ...
    def buildNetwork(self):
        ...
        with tf.compat.v1.variable_scope("LSTM"):
            ...
            self.output, self.hidden_cell_statesTuple = tf.compat.v1.nn.dynamic_rnn(cell=self.lstm_cell, inputs=self.X, dtype=tf.float32)
    ...
    def buildTraining(self):
        ...
        #Compute the l2_loss
        l2_loss = self.weight_decay*tf.compat.v1.nn.l2_loss(self.W4)
        ...
        self.meanLoss = self.errorNorm + l2_loss
