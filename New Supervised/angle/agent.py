...
class Network():
    ...
    def buildNetwork(self):
        ...
        #with tf.compat.v1.variable_scope("Norm"):
            #self.W4=tf.compat.v1.get_variable("Weights_LinearDecoder_Norm", [self.ThirdLayer_units, 1], initializer=tf.contrib.layers.xavier_initializer())
            #self.B4=tf.compat.v1.get_variable("Biases_LinearDecoder_Norm", [1], initializer=tf.contrib.layers.xavier_initializer())
        ...
        with tf.compat.v1.variable_scope("Sine"):
            self.W4=tf.compat.v1.get_variable("Weights_LinearDecoder_Sine", [self.ThirdLayer_units, 1], initializer=tf.contrib.layers.xavier_initializer())
            self.B4=tf.compat.v1.get_variable("Biases_LinearDecoder_Sine", [1], initializer=tf.contrib.layers.xavier_initializer())

            self.OutputSine=tf.matmul(self.nonlinear3, self.W4) + self.B4

        with tf.compat.v1.variable_scope("Cosine"):
            self.W5=tf.compat.v1.get_variable("Weights_LinearDecoder_Cosine", [self.ThirdLayer_units, 1], initializer=tf.contrib.layers.xavier_initializer())
            self.B5=tf.compat.v1.get_variable("Biases_LinearDecoder_Cosine", [1], initializer=tf.contrib.layers.xavier_initializer())

            self.OutputCosine=tf.matmul(self.nonlinear3, self.W5) + self.B5
    ...
    def buildTraining(self):
        ...
        self.LabelSine = tf.compat.v1.placeholder(tf.float32, shape=[None, self.n_steps], name="Label_Sine")
        self.LabelCosine = tf.compat.v1.placeholder(tf.float32, shape=[None, self.n_steps], name="Label_Cosine")
        ...
        self.meanLoss = l2_loss + self.errorSine + self.errorCosine
    ...
    def buildTensorBoardStats(self):
        ...
        self.sine_error = tf.compat.v1.placeholder(tf.float32)
        self.mergeSineErrorData = tf.compat.v1.summary.merge([tf.compat.v1.summary.scalar("sine_error", self.sine_error)])

        self.cosine_error = tf.compat.v1.placeholder(tf.float32)
        self.mergeCosineErrorData = tf.compat.v1.summary.merge([tf.compat.v1.summary.scalar("cosine_error", self.cosine_error)])
