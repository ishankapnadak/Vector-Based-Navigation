...
if __name__ == '__main__':
    ...
    with tf.compat.v1.Session() as sess:
        try:
            agent=Network(sess, lr=learning_rate, hu=LSTMUnits, lu=linearLayerUnits, clipping=clipping, weightDecay=weightDecay, batch_size=batch_size, num_features=num_features, n_steps=numberSteps)
            ...
            if(args.mode=="train"):    
                ...
                showGridCells(agent, dataGenerator, showCellsTrajectories, numberSteps, linearLayerUnits, bins)
